...
urlpatterns = [
    ...
    path('hide/', views.HideView.as_view(), name='hide'),
    path('from/', views.FromView.as_view(), name='from'),
    path('fave/', views.FaveView.as_view(), name='fave'),
    path('shownew/', views.ShowNewView.as_view(), name='shownew'),
]
